"""
Django settings for healthinsuranceusec_45600 project.
...
ROOT_URLCONF = 'healthinsuranceusec_45600.urls'
...
WSGI_APPLICATION = 'healthinsuranceusec_45600.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "healthinsuranceusec_45600 API",
    "DESCRIPTION": "API documentation for healthinsuranceusec_45600 App",
    "VERSION": "v1",
}
